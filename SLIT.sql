drop database if exists slitdb; 
...
###################################################################################################################
	...
	VALUES 	
		('Maghov', 'root', 'Magnus', 'Høvik', 'magnus@gmail.com', '12345678', FALSE),
	...
	VALUES 	('Modul 1', 'Her er modul 1', TRUE, "2016-09-14", 1, 1),
		('Modul 2', 'Her er modul 2', TRUE, "2016-09-28", 1, 1),
                ('Modul 3', 'Her er modul 3', TRUE, "2016-10-06", 1, 1),
                ('Modul 4', 'Her er modul 4', TRUE, "2016-10-14", 1, 1),
                ('Modul 5', 'Her er modul 5', TRUE, "2016-11-04", 1, 1),
		('Modul 1', 'Her er modul 1', TRUE, "2016-09-24", 2, 1),
		('Modul 2', 'Her er modul 2', TRUE, "2016-11-25", 2, 1),
                ('Modul 1', 'Her er modul 1', TRUE, "2016-09-25", 5, 1),
                ('Modul 2', 'Her er modul 2', TRUE, "2016-10-23", 5, 1),
                ('Modul 3', 'Her er modul 3', TRUE, "2016-10-28", 5, 1),
                ('Modul 1', 'Her er modul 1', TRUE, "2016-09-30", 6, 1),
                ('Modul 2', 'Her er modul 2', TRUE, "2016-10-05", 6, 1),
                ('Modul 1', 'Her er modul 1', TRUE, "2016-09-26", 7, 1),
                ('Modul 2', 'Her er modul 2', TRUE, "2016-10-07", 7, 1),
		('Modul 1', 'Her er modul 1', TRUE, "2016-09-23", 8, 1),
		('Modul 2', 'Her er modul 2', TRUE, "2016-10-15", 8, 1);
